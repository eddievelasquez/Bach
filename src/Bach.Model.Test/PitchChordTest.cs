...
public sealed class PitchChordTest
{
  ...
  public void Constructor_ShouldCreateMajorChord_WhenRootPitchProvided()
  {
    ...
    actual.Root.Should().Be( root );
    actual.Formula.Should().Be( ChordFormula.Major );
    actual.Inversion.Should().Be( 0 );
    actual.Bass.Should().Be( root );
    actual.Name.Should().Be( "C" );
    actual.Should().Equal( [Pitch.Create( PitchClass.C, 4 ), Pitch.Create( PitchClass.E, 4 ), Pitch.Create( PitchClass.G, 4 )] );
  }
  ...
  public void GetInversion_ShouldCreateExpectedInversion_WhenRequested()
  {
    ...
    actual.Inversion.Should().Be( 1 );
    actual.Bass.Should().Be( Pitch.Create( PitchClass.E, 4 ) );
    actual.Should().Equal( [Pitch.Create( PitchClass.E, 4 ), Pitch.Create( PitchClass.G, 4 ), Pitch.Create( PitchClass.C, 5 )] );
  }
  ...
  public void Constructor_WithRootAndFormula_ShouldInitializeWithProvidedValues()
  {
    ...
    actual.Root.Should().Be( root );
    actual.Formula.Should().Be( formula );
    actual.Inversion.Should().Be( 0 );
  }
  ...
  public void Constructor_WithRootAndFormulaIdOrName_ShouldInitializeWithRegistryFormula()
  {
    ...
    actual.Root.Should().Be( root );
    actual.Formula.Should().Be( Registry.ChordFormulas["Major"] );
    actual.Inversion.Should().Be( 0 );
  }
  ...
  public void Constructor_WithRootFormulaAndInversion_ShouldInitializeWithProvidedValues()
  {
    ...
    actual.Root.Should().Be( root );
    actual.Formula.Should().Be( formula );
    actual.Inversion.Should().Be( inversion );
  }
  ...
  public void Bass_ShouldReturnInvertedPitch_WhenInversionIsNonZero()
  {
    ...
    actual.Should().Be( Pitch.Create( PitchClass.E, 4 ) );
  }
  ...
  public void Constructor_WithRootAndFormulaIdOrName_ShouldResolveFormulaFromRegistry()
  {
    ...
    actual.Root.Should().Be( root );
    actual.Formula.Should().Be( Registry.ChordFormulas["Minor"] );
    actual.Inversion.Should().Be( 0 );
    actual.Bass.Should().Be( root );
  }
  ...
  public void Constructor_WithRootFormulaAndInversion_ShouldAcceptMaximumInversion()
  {
    ...
    actual.Inversion.Should().Be( maxInversion );
    actual.Root.Should().Be( root );
  }
  ...
  public void Constructor_WithRootFormulaAndInversion_ShouldGenerateCorrectPitches()
  {
    ...
    actual[0].Should().Be( Pitch.Create( PitchClass.C, 4 ) );
    actual[1].Should().Be( Pitch.Create( PitchClass.DSharp, 4 ) );
    actual[2].Should().Be( Pitch.Create( PitchClass.G, 4 ) );
  }
  ...
  public void Bass_ShouldReturnCorrectPitchForSecondInversion()
  {
    ...
    actual.Should().Be( Pitch.Create( PitchClass.D, 4 ) );
  }
  ...
  public void GetInversion_ShouldCreateNewInstance()
  {
    ...
    actual.Should().NotBeSameAs( chord );
    actual.Root.Should().Be( chord.Root );
    actual.Formula.Should().Be( chord.Formula );
  }
  ...
  public void Equals_ShouldReturnFalse_WhenOtherIsNull()
  {
    ...
    var actual = chord.Equals( (PitchChord?)null );
