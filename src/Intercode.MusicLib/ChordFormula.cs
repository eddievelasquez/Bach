...
namespace Intercode.MusicLib
{
   ...
   public class ChordFormula: IEquatable<ChordFormula>
   {
      ...
      public static readonly ChordFormula Minor = new ChordFormula("Minor", "m", "1,3b,5");
      public static readonly ChordFormula Minor7 = new ChordFormula("Minor Seventh", "m7", "1,3b,5,7b");
      public static readonly ChordFormula Minor9 = new ChordFormula("Minor Ninth", "m9", "1,3b,5,7b,9");
      public static readonly ChordFormula Minor11 = new ChordFormula("Minor Eleventh", "m11", "1,3b,5,7b,9,11");
      public static readonly ChordFormula Minor13 = new ChordFormula("Minor Thirteenth", "m13", "1,3b,5,7b,9,11,13");
      public static readonly ChordFormula Dominant7 = new ChordFormula("Dominant Seventh", "7", "1,3,5,7b");
      public static readonly ChordFormula Dominant9 = new ChordFormula("Dominant Ninth", "9", "1,3,5,7b,9");
      public static readonly ChordFormula Dominant11 = new ChordFormula("Dominant Eleventh", "11", "1,3,5,7b,9,11");
      public static readonly ChordFormula Dominant13 = new ChordFormula("Dominant Thirteenth", "13", "1,3,5,7b,9,11,13");
